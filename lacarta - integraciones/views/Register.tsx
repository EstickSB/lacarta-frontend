      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-richblack items-center justify-center">
        ...
        <div className="relative z-10 max-w-lg p-12 text-white">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Únete a los restaurantes que ya no imprimen papel. Gestiona tu carta, tus precios y tu
            identidad desde una sola cuenta maestra.
          </p>
        </div>
      </div>
            ...
            {step === 'FORM' ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-gray-400 pl-2">
                      Lo usaremos solo para reportes y seguridad.
                    </p>
                  </div>
                  ...
                  <div className="pt-4">
                    <Button
                      type="submit"
                      className="w-full justify-between group shadow-powerred/30"
                    >
                ...
                <div className="mt-8 text-center">
                  <p className="text-sm text-gray-500">
                    ...
                    <button
                      ...
                      className="text-richblack font-bold hover:underline"
                    >
                      Inicia Sesión
                    </button>
                  </p>
              ...
              >
                <div className="perspective-1000 mb-8 flex justify-center">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="font-mono text-powerred text-lg shadow-black drop-shadow-md">
                        {generatedEmail}
                      </div>
                ...
                <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                  Tu llave de acceso <b>{generatedEmail}</b> ha sido activada. Hemos enviado un link
                  de confirmación a tu correo personal.
                </p>
