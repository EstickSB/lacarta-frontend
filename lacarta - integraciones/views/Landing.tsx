  ...
  return (
    <div className="relative mx-auto border-richblack bg-richblack border-[12px] rounded-[3rem] h-[500px] sm:h-[550px] md:h-[600px] w-[260px] sm:w-[280px] md:w-[300px] shadow-2xl shadow-richblack/40 z-20 transform hover:scale-[1.02] transition-transform duration-500">
      ...
      <div className="rounded-[2.4rem] overflow-hidden w-full h-full bg-offwhite relative">
        ...
        {/* Infinite Scroll Content (PRESERVED AS REQUESTED) */}
        <motion.div
          animate={{ y: [-20, -1000] }}
        ...
        >
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              key={i}
              className="bg-white rounded-2xl p-3 shadow-sm border border-gray-100 flex gap-3 transform hover:scale-105 transition-transform duration-300"
            >
              <img
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            ...
            >
              <img
                src={`https://picsum.photos/100/100?random=${i + 150}`}
                className="w-16 h-16 rounded-xl object-cover bg-gray-200"
                alt="Food"
              />
              <div className="flex-1 space-y-2">
        ...
        <div className="absolute bottom-6 left-4 right-4 bg-white/80 backdrop-blur-xl p-4 rounded-2xl shadow-xl border border-white/50 z-10 flex justify-between items-center">
          <div className="flex flex-col">
            ...
            <span className="text-sm font-bold text-richblack">S/ 42.00</span>
          </div>
      ...
      <div className="space-y-3">
        {filteredItems.map((item) => {
          ...
          return (
            ...
            >
              <img
                src={`https://picsum.photos/50/50?random=${item.img}`}
  ...
  const locals = [
    {
      ...
      testimonial:
        'Gracias a LaCarta, optimizamos la gestión de inventario y reservas, todo en un solo lugar.',
      person: {
        name: 'Marta García',
        role: 'Propietaria',
        photo: 'https://i.pravatar.cc/150?u=marta',
        comment: 'La mejor decisión para digitalizar nuestro negocio.',
      },
      color: 'bg-green-500',
    },
    {
      ...
      testimonial:
        'La implementación fue inmediata. Ahora nuestros mozos se enfocan 100% en el servicio.',
      person: {
        name: 'Carlos Ruiz',
        role: 'Chef Ejecutivo',
        photo: 'https://i.pravatar.cc/150?u=carlos',
        comment: 'Un cambio radical en nuestra eficiencia operativa.',
      },
      color: 'bg-powerred',
    },
    {
      ...
      testimonial: 'El sistema de pedidos QR redujo los errores en cocina a cero. Imprescindible.',
      person: {
        name: 'Elena Moon',
        role: 'Manager',
    ...
    <section className="py-32 px-6 bg-white border-t border-gray-100 overflow-visible">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="font-serif text-4xl md:text-5xl mb-4 text-richblack">
            Locales Fundadores que Confían en Nosotros
          </h2>
          <p className="text-gray-500 text-lg">
            Liderando la transformación digital en la gastronomía.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {locals.map((local, i) => (
            ...
            >
              ...
              >
                <img
                  src={local.person.photo}
                  alt={local.person.name}
                  className="w-16 h-16 rounded-full object-cover mb-4 border-2 border-gray-100 shadow-sm"
                />
              ...
              {/* Bottom Strip */}
              <div
                className={`h-14 ${local.color} flex items-center justify-center gap-4 px-8 rounded-b-2xl mt-auto`}
              >
...
const FoundingLocalsForm = () => {
  return (
    <section
      id="fundadores"
      className="py-24 px-6 bg-richblack text-white relative overflow-hidden"
    >
        ...
        <div className="bg-white/5 backdrop-blur-xl p-8 md:p-12 rounded-[3rem] border border-white/10 shadow-2xl">
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-2">
...
const Landing: React.FC<LandingProps> = ({ onEnterApp }) => {
  ...
  return (
    <div className="min-h-screen bg-offwhite font-sans selection:bg-powerred selection:text-white overflow-x-hidden">
          ...
          <div className="text-center lg:text-left order-1 lg:order-1">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-gray-500 mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                Recibe pedidos desde las mesas, actualiza tu menú en segundos y evita errores. Sin
                apps, sin complicaciones.
              </p>
      ...
      <section
        id="beneficios"
        className="py-20 md:py-32 px-6 bg-white border-y border-gray-100 relative"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 md:mb-20">
            <h2 className="font-serif text-3xl md:text-5xl mb-4 text-richblack">
              Lo que pierdes <span className="text-powerred italic">HOY</span> en tu restaurante
            </h2>
            <p className="text-gray-500 text-lg">
              Cada minuto sin un sistema inteligente es dinero que se escapa.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                t: 'Errores en Pedidos',
                d: 'Meseros anotando mal o olvidando platos.',
                icon: <X className="text-red-500" />,
              },
              {
                t: 'Stock Desactualizado',
                d: 'Platos que se acaban pero siguen en la carta.',
                icon: <RefreshCw className="text-orange-500" />,
              },
              {
                t: 'Tiempo Perdido',
                d: 'Mozos explicando el menú una y otra vez.',
                icon: <Zap className="text-yellow-500" />,
              },
              {
                t: 'Ventas Perdidas',
                d: 'Clientes indecisos que terminan pidiendo poco.',
                icon: <BarChart3 className="text-gray-400" />,
              },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-gray-50 p-8 rounded-[2rem] border border-gray-100 hover:bg-white hover:shadow-xl transition-all duration-300"
              >
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="max-w-xl">
                ...
                <p className="text-gray-400">
                  Automatiza la toma de pedidos, mantén tu stock al día y deja que tus mozos se
                  enfoquen en dar un servicio de lujo.
                </p>
              </div>
              <Button
                onClick={() => {
      ...
      {/* 3. Core Feature: Mesas + Pedidos (The Real Differentiator) */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-xs font-bold text-richblack">Pedido Recibido</span>
              </div>
              <div className="space-y-2">
              ...
              <div className="mt-4 pt-4 border-t border-gray-50 flex justify-between items-center">
                <span className="text-[10px] text-gray-400">Mesa 05</span>
                <span className="text-xs font-bold text-powerred">S/ 85.00</span>
              </div>
            </motion.div>
          </div>
          ...
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-6xl mb-8 leading-tight text-richblack">
              Deja que tus clientes <br />
              <span className="text-powerred italic">pidan desde la mesa</span>.
            </h2>

            <div className="space-y-8">
              {[
                { t: 'Escanean el QR', d: 'Cada mesa tiene su código único. Sin esperas.' },
                { t: 'Ven la carta', d: 'Fotos HD y descripción detallada de cada plato.' },
                { t: 'Hacen su pedido', d: 'Personalizan su orden y confirman en segundos.' },
                {
                  t: 'Llega directo a cocina',
                  d: 'Sin mozos corriendo, sin errores de anotación.',
                },
              ].map((step, i) => (
            ...
            <div className="mt-12 p-6 bg-white rounded-3xl border border-gray-100 shadow-sm">
              <p className="text-richblack font-medium italic">
                "Sin apps, sin mozos corriendo, sin errores."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="font-serif text-4xl md:text-5xl mb-16 text-richblack">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            {[
              {
                t: 'Creas tu carta',
                d: 'Sube tus platos y precios en segundos.',
                icon: <Newspaper />,
              },
              { t: 'Generas tu QR', d: 'Descarga e imprime tus códigos únicos.', icon: <QrCode /> },
              {
                t: 'Tus clientes piden',
                d: 'Escanean, eligen y disfrutan.',
                icon: <MousePointer2 />,
              },
            ].map((step, i) => (
              <div
                key={i}
                className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm relative"
              >
      ...
      <section className="py-24 px-6 bg-offwhite">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl mb-4 text-richblack">
              Tecnología que <span className="text-powerred">vende</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-powerred/10 text-powerred rounded-2xl flex items-center justify-center mb-6">
                <LayoutDashboard />
              </div>
              <h3 className="font-bold text-xl mb-4 text-richblack">Eficiencia Operativa</h3>
              <p className="text-gray-500 leading-relaxed">
                Reduce tiempos de espera y optimiza la rotación de mesas con un flujo de trabajo
            ...
            <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="font-bold text-xl mb-4 text-richblack">Modernización Digital</h3>
              <p className="text-gray-500 leading-relaxed">
                Eleva la percepción de tu marca con una experiencia tecnológica de primer nivel para
                tus comensales.
              </p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="font-bold text-xl mb-4 text-richblack">Control de Stock</h3>
              <p className="text-gray-500 leading-relaxed">
                Marca platos como agotados en un click desde tu celular. Evita quejas innecesarias y
                mejora la gestión.
              </p>
            </div>
            <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="font-bold text-xl mb-4 text-richblack">Analítica Inteligente</h3>
              <p className="text-gray-500 leading-relaxed">
                Entiende qué platos son tus verdaderos ganadores y toma decisiones basadas en datos
                reales de consumo.
              </p>
            </div>
          </div>
      ...
      {/* 5. Pricing Section (New Model) - REMOVED FOR EARLY ACCESS */}

      {/* 6. Identity Registration Section - REMOVED FOR EARLY ACCESS */}
      ...
      <footer className="py-20 px-6 bg-richblack text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-gray-600 text-xs">
            © 2026 LaCarta Technology. Designed for the future of dining.
          </p>
        </div>
      </footer>
    </div>
