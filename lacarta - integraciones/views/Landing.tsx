  ...
  const locals = [
    {
      ...
      testimonial: "Gracias a LaCarta, optimizamos la gestión de inventario y reservas, todo en un solo lugar.",
      person: {
        name: "Marta García",
        role: "Propietaria",
    ...
    },
    {
      ...
      testimonial: "La implementación fue inmediata. Ahora nuestros mozos se enfocan 100% en el servicio.",
      person: {
        name: "Carlos Ruiz",
        role: "Chef Ejecutivo",
          ...
          <div className="text-center lg:text-left order-1 lg:order-1">
            ...
            >
              <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl font-medium leading-[1.05] mb-6 text-richblack tracking-tight">
                Convierte tu carta en un <span className="text-powerred italic relative">
                  sistema de pedidos
              ...
              <p className="text-base sm:text-lg text-gray-500 mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                Recibe pedidos desde las mesas, actualiza tu menú en segundos y evita errores. Sin apps, sin complicaciones.
              </p>
      ...
      <section id="beneficios" className="py-20 md:py-32 px-6 bg-white border-y border-gray-100 relative">
        <div className="max-w-6xl mx-auto">
           <div className="text-center mb-16 md:mb-20">
             ...
             <p className="text-gray-500 text-lg">Cada minuto sin un sistema inteligente es dinero que se escapa.</p>
           </div>
           
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { t: "Errores en Pedidos", d: "Meseros anotando mal o olvidando platos.", icon: <X className="text-red-500" /> },
                { t: "Stock Desactualizado", d: "Platos que se acaban pero siguen en la carta.", icon: <RefreshCw className="text-orange-500" /> },
                { t: "Tiempo Perdido", d: "Mozos explicando el menú una y otra vez.", icon: <Zap className="text-yellow-500" /> },
                { t: "Ventas Perdidas", d: "Clientes indecisos que terminan pidiendo poco.", icon: <BarChart3 className="text-gray-400" /> }
              ].map((item, i) => (
           ...
           <div className="mt-16 bg-richblack text-white rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="max-w-xl">
                  ...
                  <p className="text-gray-400">Automatiza la toma de pedidos, mantén tu stock al día y deja que tus mozos se enfoquen en dar un servicio de lujo.</p>
                </div>
                <Button 
                  onClick={() => {
                    const el = document.getElementById('fundadores');
          ...
          <div>
            ...
            <div className="space-y-8">
              {[
                ...
                { t: "Llega directo a cocina", d: "Sin mozos corriendo, sin errores de anotación." }
              ].map((step, i) => (
            ...
            <div className="mt-12 p-6 bg-white rounded-3xl border border-gray-100 shadow-sm">
              <p className="text-richblack font-medium italic">"Sin apps, sin mozos corriendo, sin errores."</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            {[
              { t: "Creas tu carta", d: "Sube tus platos y precios en segundos.", icon: <Newspaper /> },
              { t: "Generas tu QR", d: "Descarga e imprime tus códigos únicos.", icon: <QrCode /> },
              { t: "Tus clientes piden", d: "Escanean, eligen y disfrutan.", icon: <MousePointer2 /> }
            ].map((step, i) => (
      ...
      <section className="py-24 px-6 bg-offwhite">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl mb-4 text-richblack">Tecnología que <span className="text-powerred">vende</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
             <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-500 leading-relaxed">Reduce tiempos de espera y optimiza la rotación de mesas con un flujo de trabajo digital automatizado.</p>
             </div>
             <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-500 leading-relaxed">Eleva la percepción de tu marca con una experiencia tecnológica de primer nivel para tus comensales.</p>
             </div>
             <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-500 leading-relaxed">Marca platos como agotados en un click desde tu celular. Evita quejas innecesarias y mejora la gestión.</p>
             </div>
             <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-500 leading-relaxed">Entiende qué platos son tus verdaderos ganadores y toma decisiones basadas en datos reales de consumo.</p>
             </div>
          </div>
        </div>
      </section>
